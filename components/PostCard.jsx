    ...
    return (
        <div className='p-0 pb-12 mb-8 bg-white rounded-lg shadow-lg lg:p-8'>
            <div className="relative mb-6 overflow-hidden shadow-md pb-80">
                <img src={post.featuredImage.url} alt={post.title} className='absolute object-cover object-top w-full rounded-t-lg h-80 lg:rounded-lg'/>
            </div>
            ...
            <p className='px-4 mb-8 text-lg font-normal text-center text-gray-700 lg:px-20'>{post.excerp}</p>
